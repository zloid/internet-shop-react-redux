...
export const FETCH_CATEGOIES_START =   'FETCH_CATEGOIES_START'
export const FETCH_CATEGOIES_SUCCESS = 'FETCH_CATEGOIES_SUCCESS'
export const FETCH_CATEGOIES_FAILURE = 'FETCH_CATEGOIES_FAILURE'